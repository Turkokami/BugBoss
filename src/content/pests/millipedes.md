---
pest: millipedes
title: "Millipedes in Northeast Wisconsin: The Fall Migration That Fills Your Basement Overnight"
...
faqs:
  ...
  - q: "What is the difference between a millipede and a centipede?"
    a: "Speed and legs, and they tell you completely different things. Millipedes are slow, rounded and cylindrical in cross-section, dark brown to black, with two pairs of short legs on each body segment producing a rippling wave when they walk. They eat decaying plant matter and coil into a flat spiral when disturbed. Centipedes are fast, flattened, with one pair of long legs per segment sticking out to the sides, and they are predators that hunt other insects. If it is slow and coils up, it is a millipede; if it darts across the floor and disappears, it is a centipede."
  - q: "How do I stop millipedes getting into my house?"
    a: "Reduce the damp habitat immediately around the building and seal the ground-level routes in. Pull mulch back to leave a dry strip against the foundation, clear leaf litter, dethatch lawn that runs up to the wall, lift boards and landscape timbers off the soil, extend downspouts well clear, and regrade where water sits against the house. Then seal foundation cracks, sill plate gaps, garage door bottom seals, thresholds, and window well seals. Where a property has a history of heavy migrations, a perimeter treatment timed to the autumn event handles what the habitat work does not."
  - q: "Do millipedes bite?"
    a: "They cannot. A millipede's mouthparts scrape soft decaying plant tissue and are not capable of breaking human skin. There is no millipede in Wisconsin that bites people. What some species do is secrete a defensive chemical from glands along the body, which smells unpleasant, can cause mild irritation or temporary staining on skin, and is more of a concern for a dog or a small child who picks one up and puts it in their mouth. Even then, the result is unpleasant taste and possibly drooling rather than genuine harm."
  ...
  - q: "Why are they in my window wells?"
    a: "Window wells collect exactly what millipedes want and then trap them. Leaves and organic debris accumulate, moisture holds, the well is shaded, and an animal that drops in generally cannot climb the smooth sides to get out. So during a migration a well fills up, and there is a basement window right there with a seal that may not be perfect. Clearing debris out of the wells, improving their drainage, and fitting covers is one of the more effective single steps on a house that gets millipedes every autumn."
  - q: "Is a millipede invasion a sign of something wrong with my house?"
    a: "Not necessarily wrong, but it is telling you something. A mass arrival during an autumn migration can happen to a perfectly sound house that simply stands in the path. What it does indicate is that the ground immediately around your foundation is damp and organic enough to support a large population, and that there are ground-level gaps letting them in. Neither is an emergency, but both are worth correcting, because the same conditions support sowbugs, springtails, centipedes, and eventually more consequential moisture problems in the structure."
  - q: "Does BugBoss time treatment to the fall migration?"
    a: "Yes, and timing is most of what makes it work. A perimeter treatment applied in late summer to early autumn, before the movement begins, means arriving millipedes contact it at the foundation rather than after they are already inside. Applied in the middle of a migration it helps considerably less, and applied in July it will have degraded before it is needed. On properties with a history of heavy autumn arrivals, we schedule the treatment to the season rather than to the phone call, which is a much better use of the customer's money."
---

## The morning after

This is one of the more startling things a homeowner in this part of Wisconsin can walk into. You go down to the basement in the first week of October and the floor is scattered with dark coils — dozens of them, maybe hundreds, curled up along the base of the walls and around the floor drain. There were none yesterday.

That is a **millipede migration**, and the good news arrives quickly: nothing is wrong with your house in any structural sense, the animals are entirely harmless, and they are already dead or dying. What happened is that a very large population living in the lawn thatch, leaf litter, and mulch around your property started moving all at once, and your foundation was in the way.

The other useful thing to know is that this is an **event, not an infestation**. Millipedes cannot live indoors. The wave passes in anything from a few days to a couple of weeks, and then it is over until next year. The work worth doing is aimed at reducing how many arrive and how many get in — not at the animals already on your floor.
...
Worth settling, because they mean quite different things.

**Millipede**: slow, rounded and tube-like, dark, two pairs of short legs per segment, coils into a spiral when disturbed. Eats decaying plants. Arrives in mass numbers in autumn. Harmless.

**Centipede**: fast — startlingly so — flattened rather than round, one pair of long legs per segment splayed out to the sides, and it runs for cover rather than curling up. A predator that hunts other insects. Shows up as individuals, year-round, wherever it is damp. See the [centipedes](/pest-library/centipedes/) page.
...
**Any prolonged heavy rain in the warm months** can trigger a secondary movement, sometimes a substantial one, by flooding the habitat.

**Spring** produces a smaller, quieter movement as animals come out of overwintering, occasionally noticeable during a wet melt.

**Summer** is quiet at the building. The population is out there breeding and growing, which is what sets up the autumn.
...
**Lawn thatch running to the foundation.** A thick thatch layer is superb millipede habitat and, where the lawn meets the wall, there is no barrier at all. This is the biggest contributor on most residential properties.

**Deep mulch beds against the house.** Damp, organic, decomposing — food and shelter in one, directly against the foundation.

**Leaf litter.** Especially leaves left banked against the foundation over autumn, right when the migration happens.

**Boards, stones, and landscape timbers** lying on soil near the house, each creating a damp harborage underneath.

**Compost heaps and garden beds** close to the building.

**Wooded lots and heavy tree cover**, which is much of our service area — abundant leaf fall means abundant millipedes.

**Window wells**, which collect debris, hold moisture, trap arrivals, and sit right next to a basement window.
...
**Reacting instead of anticipating.** By the time the basement floor is covered, the migration is underway and a treatment applied that day has largely missed its window. Timing is everything with this pest.

**Sealing without reducing the habitat.** Sealing is worthwhile, but a house standing in the path of a genuine mass migration is under enormous pressure and something will find a way in. Cutting the population near the foundation is what reduces the numbers at the wall.

**Ignoring thatch.** People address the mulch and overlook the lawn, which on many properties is the larger reservoir.

**Missing the window wells.** Frequently the single biggest local concentration, and almost always overlooked until someone actually goes and looks in one.
...
**2. Inspect the foundation band.** The strip of ground within a few feet of the building: thatch depth, mulch depth and placement, leaf litter, boards and timbers on soil, grading, downspout discharge, window wells, and which sides stay damp longest.

**3. Find the entry routes.** Foundation cracks, sill plate gaps, utility penetrations, garage door bottom seals, thresholds, basement window seals, and floor drains. During a migration, animals are pressing along the whole base of the wall, so every ground-level gap counts.

**4. Seal at ground level.** This is where the work goes. Above waist height is irrelevant for millipedes.
...
- **Keep mulch shallow** — two to three inches, not piled.
- **Clear leaf litter** from against the house in autumn, before the migration rather than after.
- **Lift boards, stones, and landscape timbers** off the soil near the building.
- **Clear and cover window wells** and improve their drainage.
- **Extend downspouts** well clear and regrade so water falls away from the house.

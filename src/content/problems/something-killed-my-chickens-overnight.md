---
title: "Something Killed My Whole Flock in One Night"
answer: "Multiple birds killed in a single night, mostly uneaten, with no obvious way in, is a weasel or mink. They get through a gap about an inch across — if the head fits, the body follows — so a coop that looks sealed to you is not sealed to them. BugBoss deals with the animal and then does the exclusion work in half-inch hardware cloth that actually keeps them out."
category: "Wildlife"
order: 44
faqs:
  ...
  - q: "Will it come back?"
    a: "Yes, and soon. These animals return to what they treat as a cache site — they killed more than they could eat and instinct says the surplus is still there. That is genuinely useful information for resolving the situation, and it is also why you should not restock into an unsealed coop. If the gap is still open when the animal comes back, it will find whatever you put in there."
  - q: "Isn't chicken wire enough?"
    a: "No, and this is the single most consequential misunderstanding in backyard poultry keeping. Chicken wire is designed to keep chickens in, not predators out — the mesh openings are far too large for a weasel, which walks through without touching the sides, and the wire itself is thin enough for a determined raccoon to tear. What you need is half-inch hardware cloth: heavier gauge welded mesh with openings small enough to exclude a weasel, fastened with screws and washers rather than staples, and skirted or buried at the base."
  ...
  - q: "What should I do before restocking?"
    a: "Seal the coop properly first, then restock. Half-inch hardware cloth over every opening including windows, vents and the gaps above and below doors, fastened with screws and washers, and skirted outward about eighteen inches at ground level or buried to defeat digging. Positive-latching doors. Do the torch test to confirm. Putting new birds into the same building with the same gap, while an animal that regards it as a cache site is still in the area, is how people lose two flocks instead of one."
---

## Why this happens

There is no gentle way to describe this call. Someone goes out in the morning to let the birds out and finds every one of them dead. Not taken — dead in the coop, mostly uneaten, wounds at the head and neck. The door was shut. Nothing is torn, nothing is dug up, and there is no obvious way anything got in.

That is a **weasel**, or occasionally a **mink**, and two things need saying plainly.

**The coop was not secure, however secure it looked.** Somewhere there is an opening about an inch across, and to these animals that is an open door. Long-tailed weasels, short-tailed weasels and mink all occur here, and all of them are built as a flexible tube around a small skull. If the head fits, the body follows. A gap you would not think twice about is a route in.
...
Call after a **multi-bird loss with no obvious entry** — that combination is the weasel signature, and the coop needs going over properly before anything replaces the flock.

Call if a **rodent problem in your barn stopped without explanation**, which is worth treating as an early warning rather than good news.

Call **before you build or restock**, because getting the exclusion right at the outset is straightforward and getting it right after a loss is heartbreaking. Honestly, this is the call I wish people made first — almost every weasel job I attend is a response to a flock already dead, and almost every one was preventable with a weekend of hardware cloth.
...
Full profile at [weasels and mink](/pest-library/weasels-mink/). If the pattern does not match: [foxes](/pest-library/foxes/) take one bird and carry it off, [raccoons](/pest-library/raccoons/) tear their way in and leave a mess, [rats](/pest-library/rats/) take eggs and chicks, and [opossums](/pest-library/opossums/) get blamed for far more than they actually do.

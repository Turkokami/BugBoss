...
export const pests: Pest[] = [
  ...
  },
  {
    ...
    overview: 'Springtails live in soil, mulch, and leaf litter, feeding on mould and decaying plant matter, and they move indoors in numbers when the outside dries out or floods. They jump when disturbed, using a spring-loaded appendage under the abdomen, which is what separates them from fleas at a glance. Every serious springtail call traces back to standing moisture.',
  ...
  },
  {
    ...
    signs: ['Grey segmented bugs, usually dead, on basement and garage floors', 'Live ones under mulch, boards, stones, and landscape timbers against the house', 'Numbers rising after heavy rain or spring melt', 'Damp sill plates, window wells, or a crawlspace with a bare dirt floor'],
    faqs: [
  ...
  },
  {
    ...
    overview: 'Clover mites feed on grass and clover, not on people or property, and they build enormous populations in lush, well-fertilised lawns that run right up to the foundation. When conditions shift they climb the warm sunny walls and get in around window frames and siding gaps. They are strictly a nuisance, but the staining and sheer numbers make them a genuine complaint.',
    signs: ['Tiny bright red or reddish-brown specks moving on sills, siding, and window frames', 'A rust-coloured smear when one is wiped or crushed', 'Concentrations on the sunny south and west walls in early spring', 'Thick, well-fertilised lawn growing right against the foundation'],
    faqs: [
      ...
      { q: 'What is the red stain when I squash one?', a: 'It is the mite’s own body pigment, not blood. It stains light-coloured sills, curtains, carpet, and paint readily, which is why vacuuming is much better than wiping or crushing them.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How do I know it is flying squirrels and not grey squirrels?', a: 'Timing is the giveaway. Grey and red squirrels are active at dawn and through the day; flying squirrels are strictly nocturnal, so the noise starts at dusk and continues through the night. Flying squirrels also sound lighter and faster.' },
  ...
  },
  {
    ...
    signs: ['Gnawed plywood, deck rails, tool handles, or vehicle tyres and hoses', 'Bark stripped from the upper trunk and branches, with nipped twigs below', 'A well-used den entrance under a shed, barn, or porch with quills and scat nearby', 'Trails worn through snow to and from a den'],
    faqs: [
      ...
      { q: 'Why is a porcupine chewing my deck and tools?', a: 'Salt. Porcupines crave sodium, so plywood glues, sweat-soaked tool handles, road-salted vehicle parts, and treated deck rails all become targets. The chewing looks random until you realise it is following the salt.' },
  ...
  },
  {
    ...
    signs: ['Kits playing outside a hole under a shed, deck, or barn in spring', 'A den entrance about eight inches across with a fan of excavated soil', 'Scattered feathers, bones, and a strong musky odour near the den', 'Poultry taken during daylight, usually one bird at a time'],
    faqs: [
      { q: 'Are foxes dangerous to people or pets?', a: 'Very rarely. Foxes are small, shy, and avoid people; healthy ones do not attack adults or dogs. Cats, poultry, and rabbits are genuinely at risk. A fox out in daylight is normal behaviour, not by itself a sign of rabies.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Do rabbit repellents work?', a: 'Briefly. Taste and odour repellents wash off with rain and snowmelt and need constant reapplication, and hungry rabbits in late winter often ignore them. Fencing and trunk guards are what actually hold.' },
